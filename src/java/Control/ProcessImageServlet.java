...
public class ProcessImageServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Part imgFilePart = request.getPart("fileX");
//            out.print(imgFilePart.getSubmittedFileName());
//          Save image to location on server
            imgFilePart.write(ConfigInfo.getCtxRealPath() + "\\resources\\uploadedIMG\\" + imgName + ".jpg");

            String target = "showImage.jsp";
            RequestDispatcher reqDispatch = request.getRequestDispatcher(target);
            
            String imageLocation="resources\\uploadedIMG\\" + imgName + ".jpg";
            request.setAttribute("imgLocation", imageLocation);
